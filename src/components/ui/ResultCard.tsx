        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex flex-wrap gap-3 text-xs" style={{ color: "#8888aa" }}>
            {data.view_count != null && (
              <span>👁 {formatCount(data.view_count)}</span>
            )}
            {data.like_count != null && (
              <span>❤️ {formatCount(data.like_count)}</span>
            )}
            {data.comment_count != null && (
              <span>💬 {formatCount(data.comment_count)}</span>
            )}
            <span
...
function OptionGroup({
  ...
  return (
    <div className="mb-3">
      <p className="mb-1.5 text-[11px] font-medium" style={{ color: "#8888aa" }}>
        {label}
      </p>
            ...
            >
              <div>
                ...
                <p className="text-xs" style={{ color: "#8888aa" }}>
                  {item.quality}
                  {item.size_approx ? ` · ${item.size_approx}` : ""}
                </p>
              </div>
